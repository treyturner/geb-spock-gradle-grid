package info.treyturner.qa.demo.spec

import info.treyturner.qa.demo.WebApplicationSpecification
import info.treyturner.qa.demo.page.GoogleResultsPage
import info.treyturner.qa.demo.page.GoogleSearchPage
